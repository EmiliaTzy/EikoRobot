...
DEFAULT_WELCOME_MESSAGES = [
    "{first} telah disini!",  # Discord welcome messages copied
    "Selamat Datang {first}",
    "Halo, {first} Semoga Betah Disini Ya.",
    "Saya Sangat Senang {first} Ada Disini", 
    "Salam Hangat Dariku Untukmu {first}", 
]

DEFAULT_GOODBYE_MESSAGES = [
    "{first} Akan Kami Rindukan.",
    "Selamat Tinggal {first}.",
    "{first} Telah Meninggalkan Obrolan.",
    "{first} Selamat Jalan, Hati-hati Dijalan ya."
    "Senang Mendengarmu, {first}!",
    "Itu Merupakan Waktu yang Menyenangkan {first}.",
    "Kami Berharap Dapat Melihatmu Lagi Segera, {first}.",
    "Aku Tidak Ingin Mengucapkan Selamat Tinggal, {first}.",
    "Selamat Tinggal {first}! Tebak Siapa Yang Akan Merindukanmu :')",
    "Selamat Tinggal {first}! Ini Akan Menjadi Kesepian Tanpamu.",
]
